...
import { checkForDropsInMigrationsFiles, detectTableOrColumnDrop, getModifiedFiles, getOctokitClient, warnWithCommentOnPR, } from './utils.js';
...
async function run() {
    try {
        ...
        const hasTableOrColumnDrop = checkForDropsInMigrationsFiles(migrationFiles, detectTableOrColumnDrop);
