...
import { checkForDropsInMigrationsFiles, detectDropTable, getModifiedFiles, getOctokitClient, warnWithCommentOnPR, } from './utils.js';
...
async function run() {
    try {
        ...
        const hasTableOrColumnDrop = checkForDropsInMigrationsFiles(migrationFiles, detectDropTable);
